...
> Convención de proceso para el proyecto **KAN** (`alpaqa.atlassian.net`). **Jira es la fuente
...
- **Épica** agrupa un dominio o un frente de trabajo.
  - `KAN-1` — Catálogo e inventario (13 HUs: `KAN-2`..`KAN-14`).
  - `KAN-15` — Plataforma / Cimiento del backend (8 tareas de fase: `KAN-16`..`KAN-23`,
...
2. **Vinculación código ↔ issue**: la rama y el PR llevan la key del issue
   (`KAN-3-crear-producto-simple`); el cuerpo del PR referencia la key.
...
4. **El cimiento también se rastrea** (épica `KAN-15`), no solo las HUs de negocio.
...
- `KAN-16` (F0 — versiones) y `KAN-17` (F1 — init + estructura): **Finalizada**.
- `KAN-18`..`KAN-23` (F2..F7): Por hacer.
- `KAN-1` y sus HUs (`KAN-2`..`KAN-14`): Por hacer (no arrancan hasta tener el cimiento).
